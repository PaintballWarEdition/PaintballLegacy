...
public class Gifts {
	...
	public static void receiveGift(Player player, int amount, boolean all) {
		if(all) player.sendMessage(Paintball.instance.t.getString("ALL_RECEIVED_GIFT"));
		else player.sendMessage(Paintball.instance.t.getString("RECEIVED_GIFT")) ;
	...
	public static void giveGift(Player goodGuy, Player receiver) {
		...
		receiver.sendMessage(Paintball.instance.t.getString("RECEIVED_GIFT_FROM", vars)) ;
		goodGuy.sendMessage(Paintball.instance.t.getString("GAVE_GIFT_TO", vars)) ;

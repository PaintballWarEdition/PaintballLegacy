...
public class Rocket {
	...
	public synchronized void die() {
		...
		entity.getWorld().playEffect(loc,
				Effect.MOBSPAWNER_FLAMES, 4);
		entity.getWorld().playEffect(loc,
				Effect.MOBSPAWNER_FLAMES, 5);
		entity.getWorld().playEffect(loc,
				Effect.MOBSPAWNER_FLAMES, 6);
		entity.getWorld().playEffect(loc,
				Effect.MOBSPAWNER_FLAMES, 7);
		entity.getWorld().playEffect(loc,
				Effect.MOBSPAWNER_FLAMES, 8);
	...
	private void moveExpSnow(final Snowball s, Vector v, Player player, Paintball plugin) {
		s.setShooter(player);
		Vector v2 = v;

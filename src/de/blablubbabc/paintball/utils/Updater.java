...
public class Updater {
	...
	private static final String[] NO_UPDATE_TAG = { "-COMPAT", "-DEV", "-PRE", "-SNAPSHOT" }; // If the version number contains one of these, don't update.
	 ...
	 * </p>
	 * <p>
	 * Updater will call this method from {@link #versionCheck(String)} before deciding whether the remote version is actually an update. If you have a specific versioning scheme with which a
	 * mathematical determination can be reliably made to decide whether one version is higher than another, you may revise this method, using the local and remote version parameters, to execute the
	 * appropriate check.
	 * </p>
	 * <p>

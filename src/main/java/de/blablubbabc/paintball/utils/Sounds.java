...
public class Sounds {
	...
	public static void playHit(Player shooter, Player target) {
		shooter.playSound(shooter.getEyeLocation(), Sound.ENTITY_MAGMA_CUBE_SQUISH_SMALL, 1F, 1F);
	...
	public static void playFrag(Player killer, Player target) {
		killer.playSound(killer.getEyeLocation(), Sound.ENTITY_MAGMA_CUBE_SQUISH_SMALL, 1F, 0F);
